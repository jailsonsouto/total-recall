# Agente 4 — Consumer Intelligence
...
O Agente 4 é a camada de escuta do sistema multi-agente. Enquanto o Agente 1 avalia o alinhamento com o Código Genético da marca e o Agente 2 prevê o BVS, o Agente 4 responde a uma pergunta diferente: **o que a consumidora real — cacheada, enrolada, henêgata — já pensa sobre produtos desta categoria?**

---

## O que ele faz

Antes de um briefing ser finalizado, o Agente 4 consulta o corpus de comentários de TikTok coletados sobre a categoria do produto. A partir de um corpus de 4.800+ comentários reais e crescendo, ele extrai:
...
O TCC constrói o motor analítico: coleta, anotação, fine-tuning do BERTimbau, framework ASTE. O Agente 4 usa esse motor para gerar inteligência de produto em tempo real. **O TCC não é um projeto paralelo — é a Fase 1 do Agente 4.**

```
TCC (Fase 1)                    Agente 4 (Fase 2)
─────────────────────────────── ──────────────────────────────
...
## O que o Agente 4 entrega ao briefing
...
Fase 2 — Agente 4 operacional  [roadmap: após Fase 1]
...
Fase 3 — Integração LangGraph  [roadmap: após Agente 8 conectado]
  ✗ Agente 4 como nó do grafo multi-agente
