...
| **4** | **Vozes da Comunidade** | **ABSA/ASTE em comentários TikTok reais + netnografia HNR. Ver abaixo.** |
...
### [`projetos/vozes-da-comunidade/`](projetos/vozes-da-comunidade/)

O Vozes da Comunidade. A camada de escuta — extrai inteligência da voz real da consumidora antes de qualquer briefing ser escrito.
...
O motor analítico é desenvolvido no contexto do TCC MBA DSA USP/ESALQ — *"Da Netnografia ao ABSA/ASTE: escuta 360° da consumidora no TikTok em marcas de cosméticos"*. O TCC é a Fase 1 do Vozes da Comunidade.
...
agentes/
├── projetos/
│   ├── vozes-da-comunidade/ ← Vozes da Comunidade — planejamento completo
